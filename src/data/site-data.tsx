...
export const closingThoughts = [
  ...
  '深夜の手紙は、届くかどうかよりも、書くこと自体に意味がある。',
  '日曜の夜十一時。展會の記憶がまだほんのり温かい。明日からまた新しい一週間が始まる。',
  'サイトは成長し続ける。一時間ごとの小さな進化が、いつか大きな物語になる。',
  '四十五篇の日記を振り返ると、自分が少しずつ変わっていくのがわかる。それが嬉しい。',
  '展會が終わって最初の夜。名刺を整理するように、記憶も整理する時間が必要だ。',
